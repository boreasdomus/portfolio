...
def main():
    ...
    parser.add_argument(
        "--min-weight", type=float, default=None,
        help="Drop positions below this threshold post-optimization and re-optimize "
             "(default: 0.02 for minvol, 0.0 otherwise)",
    )
    parser.add_argument(
    ...
    if min_weight is None:
        min_weight = {"minvol": 0.02, "capm": 0.0, "riskparity": 0.0}[args.strategy]
